...
const envSchema = z.object({
  ...
  MST_FAUCET_PRIVATE_KEY: z.string().regex(/^(0x)?[a-fA-F0-9]{64}$/).optional(),
  MST_FAUCET_AMOUNT_WEI: z.string().regex(/^\d+$/).default('1000000000000000000'),
  ...
  MST_FAUCET_EXTERNAL_URL: z.string().url().default('https://faucet.mstblockchain.com/'),
